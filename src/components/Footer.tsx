...
function LastUpdate() {
  return (
    <a
      href="https://github.com/achrafsekri"
      target="_blank"
  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m Achraf, a <strong>FullStack developer</strong> who is
        passionate about building web apps and a UX enthusiast.
      </p>
      <ul className={clsx('-ml-2 flex gap-1')}>
        <li>
          <a
            href="https://linkedin.com/in/achrafsekri"
            target="_blank"
            rel="noreferrer nofollow"
      ...
      <div className={clsx('content-wrapper')}>
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, Achraf Sekri
          </div>
